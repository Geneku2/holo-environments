...
il2cpp_hresult_t IMap_2_GetView_m650B7662215790132A28AF603A9D890FE5402F15_ComCallableWrapperProjectedMethod(RuntimeObject* __this, IMapView_2_tFA68F36C41398F2828C2F0D718DB500785DA7308** comReturnValue)
{
	...
	if (returnValue != NULL)
	{
		if (il2cpp_codegen_is_import_or_windows_runtime(returnValue))
		{
			il2cpp_hresult_t hr = ((Il2CppComObject *)returnValue)->identity->QueryInterface(IMapView_2_tFA68F36C41398F2828C2F0D718DB500785DA7308::IID, reinterpret_cast<void**>(&_returnValue_marshaled));
			il2cpp_codegen_com_raise_exception_if_failed(hr, false);
		}
		else
		{
...
il2cpp_hresult_t IMapView_2_Split_mD89FE01016C214883C79B5B78D51401C9BD5414E_ComCallableWrapperProjectedMethod(RuntimeObject* __this, IMapView_2_tFA68F36C41398F2828C2F0D718DB500785DA7308** ___first0, IMapView_2_tFA68F36C41398F2828C2F0D718DB500785DA7308** ___second1)
{
	...
	if (____first0_empty != NULL)
	{
		if (il2cpp_codegen_is_import_or_windows_runtime(____first0_empty))
		{
			il2cpp_hresult_t hr = ((Il2CppComObject *)____first0_empty)->identity->QueryInterface(IMapView_2_tFA68F36C41398F2828C2F0D718DB500785DA7308::IID, reinterpret_cast<void**>(&*___first0));
			il2cpp_codegen_com_raise_exception_if_failed(hr, false);
		}
		else
		{
	...
	if (____second1_empty != NULL)
	{
		if (il2cpp_codegen_is_import_or_windows_runtime(____second1_empty))
		{
			il2cpp_hresult_t hr = ((Il2CppComObject *)____second1_empty)->identity->QueryInterface(IMapView_2_tFA68F36C41398F2828C2F0D718DB500785DA7308::IID, reinterpret_cast<void**>(&*___second1));
			il2cpp_codegen_com_raise_exception_if_failed(hr, false);
		}
		else
		{
